...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits() {
    ...
    unitlist.append(ZENIQ);
    unitlist.append(mZENIQ);
    unitlist.append(uZENIQ);
    unitlist.append(SAT);
    return unitlist;
}
...
QString BitcoinUnits::ticker(int unit) {
    switch (unit) {
        case ZENIQ:
            return QString("ZENIQ");
        case mZENIQ:
            return QString("mZENIQ");
        case uZENIQ:
            return QString::fromUtf8("μZENIQ");
        default:
            return QString("Satoshi");
    }
}
...
QString BitcoinUnits::description(int unit) {
    ...
    switch (unit) {
        case ZENIQ:
            return QObject::tr("ZENIQ");
        case mZENIQ:
            return QObject::tr("milliZENIQ") + " (1 / 1" + thinUtf8 + "000)";
        case uZENIQ:
            return QObject::tr("microZENIQ") + " (1 / 1" + thinUtf8 + "000" + thinUtf8 + "000)";
        default:
            return QString("Satoshi");
    }
}
