...
SplashScreen::SplashScreen(interfaces::Node &node,
    ...
    QString versionText = QString("Version %1").arg(QString::fromStdString(FormatFullVersion().substr(0,7)));
    ...
    QRect rectIcon(QPoint(20, 10), QSize(229, 229));

    const QSize requiredSize(229, 229);
