...
/**
 * Zeniq address entry widget validator, checks for valid characters and
...
public:
    explicit AddressEntryValidator(const std::string &cashaddrprefixIn,
                                          QObject *parent);
...
/** Zeniq address widget validator, checks for a valid Zeniq address.
 */
