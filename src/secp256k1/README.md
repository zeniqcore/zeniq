...
This library is used for consensus critical cryptographic operations on the Zeniq network. It is maintained within the Zeniq Node repository while following upstream sources which include Bitcoin Cash Node, Bitcoin Core and Bitcoin ABC.

This library is intended to be the highest quality publicly available library for cryptography on the secp256k1 curve. However, the primary focus of its development has been for usage in the Zeniq system and usage unlike Bitcoin's may be less well tested, verified, or suffer from a less well thought out interface. Correct usage requires some care and consideration that the library is fit for your application's purpose.
