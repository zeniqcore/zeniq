...
static constexpr Amount MICROZENIQ = 100 * SATOSHI;
static constexpr Amount MILLIZENIQ = 100 * 1000 * SATOSHI;
 ...
 * currently happens to be less than 21,000,000 for various reasons, but
