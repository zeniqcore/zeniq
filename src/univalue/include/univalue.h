...
public:
     ...
     * VFALSE and VTRUE are Zeniq Node extensions of the UniValue API (replacing VBOOL).
     */
    enum VType {
        VNULL  = 1 << 0,
        VFALSE = 1 << 1,
     ...
     * Can be used with is().
     *
     * This is a Zeniq Node extension of the UniValue API.
     */
...
public:
     ...
     *
     * Compatible with the upstream UniValue API.
     * Non-const overload is a Zeniq Node extension.
     */
