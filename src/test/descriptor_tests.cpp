...
BOOST_AUTO_TEST_CASE(descriptor_test) {
    ...
    Check("combo(MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH)",
          "combo("
    ...
    Check("pk(MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH)",
          "pk("
          "03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)",
          SIGNABLE,
          {{"2103a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5"
    ...
    Check("pkh([deadbeef/1/2'/3/4']"
          "MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH)",
    ...
    Check(
        "combo(5b6X3Kq3rZPrKxWYA9zQEAjU7HJqC6N8H6QtPPWtyPCy8Bf1NXX)",
        "combo("
    ...
    Check("pk(5b6X3Kq3rZPrKxWYA9zQEAjU7HJqC6N8H6QtPPWtyPCy8Bf1NXX)",
          "pk("
          ...
          {{"4104a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5"
            ...
            "ac"}});
    Check("pkh(5b6X3Kq3rZPrKxWYA9zQEAjU7HJqC6N8H6QtPPWtyPCy8Bf1NXX)",
          "pkh("
          "04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b"
          "8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)",
    ...
    Check(
        "sh(pk(MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH))",
        "sh(pk("
        "03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))",
        SIGNABLE, {{"a9141857af51a5e516552b3086430fd8ce55f7c1a52487"}});
    Check(
        "sh(pkh(MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH))",
        "sh(pkh("
        "03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))",
    ...
    Check("multi(1,MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH,"
          "5b6X3Kq3rZPrKxWYA9zQEAjU7HJqC6N8H6QtPPWtyPCy8Bf1NXX)",
          "multi(1,"
          "03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd,"
          "04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b"
          "8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)",
    ...
    CheckUnparsable(
        "sh(MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH)",
        "sh("
        "03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)");
    ...
    CheckUnparsable(
        "sh(sh(pk(MFVMbG75bjyrig1NXQgMX7xSeiyhhxgF82tRopNxPs1piWQTTmNH)))",
        "sh(sh(pk("
        "03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))"
        ")");
}
