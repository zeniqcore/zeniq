...
static const std::string strSecret1 =
    "5ZWULnGAR6wdd7U5JXGkZfU2Ue9tvdsTanTcWvnTd1JpToobPgf";
static const std::string strSecret2 =
    "5ak24bSUZKQt6ovadg667mouMHUMGxVfjUYmxyn8xjKKuDimYJp";
static const std::string strSecret1C =
    "M8V5gJmvZPE8ePYVzLcXHAnHWzzGBjjiL7eTm6PeVvMeV8EW8qve";
static const std::string strSecret2C =
    "MDvsgs1SdeGQYe7VSsXTatn24XhiVRwXxUbFU5cE8ymtRBY8Krog";
static const std::string addr1 =  "mfSC9JFuAvXs14dkziXdezox1DgDHdNYGU";
static const std::string addr2 =  "mWGKPArwTT3vxJeQsJLPvGabGkZiQgRuyw";
static const std::string addr1C = "mdyfAkfa4E9hcsdRzg67dNZr61kzKZShnz";
static const std::string addr2C = "mTc5LEm373VtwxW42ZXmc8vDurnugc14Gv";

static const std::string strAddressBad = "mYfVeYqZU8YLuQQ6SFJENvpmzgCk4wnEb4";
