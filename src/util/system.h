...
public:
    enum Flags {
         ...
         * zeniqnet were used while running on regtest (or vice-versa).
         * Setting them as NETWORK_ONLY ensures that sharing a config file
         * between zeniqnet and regtest won't cause problems due to these
...
public:
    ...
    /**
     * Looks for -regtest and returns the appropriate BIP70 chain
     * name.
     * @return CBaseChainParams::ZENIQ by default; raises runtime error if an
