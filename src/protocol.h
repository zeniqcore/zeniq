...
enum ServiceFlags : uint64_t {
    ...
    // chain. It is currently set by all Zeniq Node non pruned nodes, and is
    // unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo
    // protocol request. Zeniq Node does not support this but a patch set
    ...
    // connections. Zeniq Node nodes used to support this by default, without
