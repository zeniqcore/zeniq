...
public:
    ...
    uint32_t MinterCount() const { return nVersion & 0xFFFF; }
    uint32_t ZeniqVersion() const { return nVersion & 0xFFFF0000; }
    void EncodeMinterCount(uint32_t voutsize)
    { nVersion = (nVersion & 0xFFFF0000) | voutsize;}
