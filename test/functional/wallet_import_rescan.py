...
import RPC call and node 0 sends ZENIQ to it. Then other nodes import the
...
In the second part of the test, node 0 sends more ZENIQ to each address, and the
