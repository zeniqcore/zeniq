...
class ValidateblocktemplateTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        tx5 = create_transaction(prev_block.vtx[0], 0, op1, [int((MAX_MONEY_ZENIQ+1) * COIN)])
        ...
        # Note: No RPC method like BU's 'setminingmaxblocksize' yet,
