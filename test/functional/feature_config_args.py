...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'zeniq.conf'), 'a', encoding='utf-8') as conf:
        ...
        self.nodes[0].assert_start_raises_init_error(
            expected_msg='Error: acceptnonstdtxn is not currently supported for zeniq chain')
        ...
        with open(inc_conf_file_path, 'w', encoding='utf-8') as conf:
            conf.write('testnet.datadir=1\n')
        with open(inc_conf_file2_path, 'w', encoding='utf-8') as conf:
            conf.write('[testnet]\n')
        self.restart_node(0)
        self.nodes[0].stop_node(expected_stderr='Warning: ' +
            inc_conf_file_path + ':1 Section [testnet] is not recognized.' +
            os.linesep +
            'Warning: ' + inc_conf_file2_path +
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "zeniq.conf")
