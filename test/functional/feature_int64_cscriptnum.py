...
"""
This tests the planned upgrade8 feature: 64-bit script integers
as well as the re-enabled OP_MUL opcode.
The test is run with -regtest, because it does not work with dma transactions.
"""
...
class Int64CScriptNum(BitcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        self.block_heights = {}
        self.extra_args = [
            ["-regtest", "-upgrade8activationtime=1605441600", "-acceptnonstdtxn=1"],
        ]
