...
class GetBlockTemplateTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-10, "Zeniq is downloading blocks...", self.nodes[0].getblocktemplate)
        ...
        assert_raises_rpc_error(-9, "Zeniq is not connected!", self.nodes[0].getblocktemplate)
        assert_raises_rpc_error(-9, "Zeniq is not connected!", self.nodes[1].getblocktemplate)
