...
License: CC0-1.0
Comments-Summary: internal review comments.
```
...
NOTE: The first element of the Merkle path list will be a transaction hash
      ...
      on the size of the job id string, for example the Zeniq
...
(2) The coinbase field has an enforced minimum size of 100 bytes.
    ...
    For example, in the Zeniq software a maximum of 1000 bytes are
...
This specification is based on an adaptation by Zeniq of a
...
branch construction in the Zeniq source code [4].
